...
export const CONFIG = {
  ...
  // C'est la Publication, « Festival — Données du site (production) », celle que sert le
  // Worker de prod, aux mêmes onglets « Export … » (ADR-0019, docs/publication.md).
